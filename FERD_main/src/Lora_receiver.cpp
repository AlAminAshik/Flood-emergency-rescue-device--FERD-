...
//     Serial.println(packetSize); // received a packet
...
//       display.setTextColor(SSD1306_WHITE); // set text color to white
//       display.setCursor(0,0);          // set cursor to top left corner
//       display.print("Data Received: ");     // print "Data Received: " on the display
//       display.setCursor(0,20);         // set cursor to second line
//       display.println(receivedData);     // print the received data on the display
//       display.display();               // update the display
//       delay(1000); // wait for 2 seconds to display the data
//       display.clearDisplay();           // clear the display
//     }
//   }